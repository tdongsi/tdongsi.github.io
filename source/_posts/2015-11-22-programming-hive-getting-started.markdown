---
layout: post
title: "Programming Hive (Pt. 2): Getting Started"
date: 2015-11-23 18:24:30 -0800
comments: true
categories: 
- Book
- Hadoop
...
hive-exec*.jar and hive-metas*.jar are in /usr/lib/hive/lib, /usr/lib/hive/bin
